...
(
	RSRV_ID int IDENTITY(1,1) primary key,
	H_CODE int foreign key references HOTEL(H_CODE) DEFAULT 1,
...
ALTER TABLE RESERVATION ADD CHECK(CHECK_OUT>CHECK_IN)
...
insert into GUEST
values
	('Anvar Sadyk', '8 (707) 456 90 00', 'Nur-Sultan', 'VISA, 4532099626602164'),
	('Serik Baymeken', '8 (707) 444 67 45', 'Atyrau', 'VISA, 4024007124705954'),
	('Assyl Aidar', '8 (711) 500 61 26', 'Taldykorgan', 'VISA, 4024007118383495'),
	('Arsen Sardyk', '8 (711) 627 55 36', 'Sochi', 'VISA, 4539478018205211'),
	('Kozha Zhanqulov', '8 (712) 106 63 69', 'Oral', 'VISA, 4916738312766363'),
	('Sara Bayit', '8 (349) 530 63 73', 'Moscow', 'VISA, 4716851877537392'),
	('Kenzhebek Myrzam', '8 (710) 657 27 55', 'Saryagash', 'VISA, 4024007182109552'),
	('Assyl Sadvakasova', '+996 312 465789', 'Bishkek', 'VISA, 4024007150236130'),
	('Arman Nadirkhan', '8 (702) 169 78 42', 'Oral', 'MASTERCARD, 5131419184497058'),
	('Erbolat Bedelkhan', '8 (700) 587 69 23', 'ALmaty', 'MASTERCARD, 5215578085850100'),
	('Aida Serikova', '+996 312 505709', 'Osh', 'MASTERCARD, 5541518874590801'),
	('Dana Zhetpisova', '8 (349) 880 86 33', 'Oskemen', 'MASTERCARD, 5206143089959802'),
	('Dmitriy Stepanov', '8 (835) 058 72 42', 'Saint Petersburg', 'MASTERCARD, 5212548318092724'),
	('Alex Zaytsev', '8 (346) 440 36 62', 'Kazan', 'MASTERCARD, 5544187231482941'),
	('Pelageya Petrova', '8 (437) 994 94 94', 'Novosibirsk', 'MASTERCARD, 5532823872547071');

insert into RESERVATION(GUEST_ID, RSRV_DATE, CHECK_IN, CHECK_OUT, PAYMNT_TYPE)
values
	(3, '2022-03-13', '2022-03-14 14:00', '2022-03-17 12:00', 'online'),
	(13, '2022-01-23', '2022-01-23 17:20', '2022-02-06 09:00', 'by cash'),
	(10, '2022-03-08', '2022-03-08 21:00', '2022-03-13 12:00', 'by cash'),
	(1, '2021-12-28', '2021-12-28 19:00', '2022-01-02 12:00', 'online'),
	(2, '2021-12-28', '2021-12-28 21:00', '2022-01-03 9:00', 'by cash'),
	(4, '2022-03-06', '2022-03-08 15:00', '2022-03-10 10:00', 'online'),
	(5, '2022-02-23', '2022-02-23 22:00', '2022-02-24 12:00', 'online'),
	(6, '2021-09-20', '2021-10-14 15:00', '2021-10-28 12:00', 'online'),
	(7, '2021-11-23', '2021-11-23 19:00', '2021-11-27 12:00', 'by cash'),
	(8, '2022-03-05', '2022-03-08 20:00', '2022-03-13 09:00', 'online'),
	(9, '2021-08-01', '2021-08-01 16:00', '2021-08-08 12:00', 'by cash'),
	(11, '2021-08-01', '2021-08-01 21:21', '2021-08-03 12:00', 'by cash'),
	(12, '2021-08-01', '2021-08-01 21:05', '2022-03-03 12:00', 'online'),
	(14, '2022-01-23', '2022-01-23 17:40', '2022-02-06 09:00', 'online'),
	(15, '2022-01-23', '2022-01-23 17:33', '2022-02-06 09:00', 'online');
...
while @cnt <=15
begin
	insert into BILL (RSRV_ID, DATE_TIME, TOTAL_PRICE)
	VALUES(@cnt, GETDATE(), 0)
	set @cnt = @cnt + 1
end;
